...
export function Questionnaire({
  ...
  const normalizedQuestions = useMemo(
    () =>
      normalizeQuestions(
        questions.length > 0 ? questions : SAMPLE_QUESTIONS
      ),
    [questions]
  )
  ...
  >(() => {
    ...
    return stored === 'vertical' || stored === 'horizontal'
      ? stored
      : initialMode
  })
      ...
      <Card withBorder radius="xl" p="lg">
        <Group justify="space-between" align="flex-start">
          ...
          <Tabs
            value={mode}
            onChange={(value) =>
              setMode(value as 'horizontal' | 'vertical')
            }
          >
            <Tabs.List grow>
              <Tabs.Tab
